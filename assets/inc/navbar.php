...
?>
    <nav class="navbar navbar-expand fixed-top be-top-header">
        ...
        <div class="be-navbar-header"><a class="navbar-brand" href="pass-dashboard.php"><img class="logo-img" src="assets/img/train1.png" alt="logo" width="{conf.logoWidth}" height="45"></a>
          </div>
