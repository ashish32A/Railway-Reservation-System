            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="fa-regular fa-credit-card " style="padding-right:10px">  </i><span>Transaction</span></a>
                    <ul class="sub-menu">
                      <li><a href="pass-all-transaction.php"><span class="badge badge-success float-right">View</span>History</a>
