...
<body>
    ...
    <div class="be-wrapper be-fixed-sidebar">
            ...
            <div class="main-content container-fluid">
                ...
                ?>
                                ...
                                <div class="value"><span
                                        ...
                                        class="number" data-toggle="counter" data-end="<?php echo $pass;?>">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                ?>
                                ...
                                <div class="value"><span
                                        class="indicator indicator-positive mdi mdi-chevron-right"></span><span
                                        class="number" data-toggle="counter" data-end="<?php echo $train;?>">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                  ...
                  ?>
                    ...
                    <div class="col-12 col-lg-6 col-xl-3">
                        <div class="widget widget-tile">
                            <div class="chart sparkline"><i class="material-icons">payment</i></div>
                            <div class="data-info">
                                <?php
                    //code for summing up number of trains tickets
                    $result ="SELECT count(*) FROM `payment_transaction` ";
                    $stmt = $mysqli->prepare($result);
                    $stmt->execute();
                    $stmt->bind_result($transaction);
                    $stmt->fetch();
                    $stmt->close();
                  ?>
                                ...
                                <div class="value"><span
                                        class="indicator indicator-positive mdi mdi-chevron-right"></span><span
                                        class="number" data-toggle="counter"
                                        data-end="<?php echo $transaction;?>">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
              ...
              <div class="chart sparkline"><i class="material-icons">local_activity</i></div>
                ...
                ?>
                                ...
                                <div class="value"><span
                                        class="indicator indicator-positive mdi mdi-chevron-right"></span><span
                                        class="number" data-toggle="counter" data-end="<?php echo $ticket;?>">0</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card card-table">
                            <div class="card-header">Trains
                                ...
                                <div class="tools dropdown"><span class=""></span><a class="dropdown-toggle" href="#"
                                        role="button" data-toggle="dropdown"><span class=""></span></a>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-table">
                            <div class="card-header"> All Passenger
        ...
        <script src="assets/lib/datatables/datatables.net-bs4/js/dataTables.bootstrap4.js" type="text/javascript">
        </script>
        <script src="assets/lib/datatables/datatables.net-buttons/js/dataTables.buttons.min.js" type="text/javascript">
        </script>
        <script src="assets/lib/datatables/datatables.net-buttons/js/buttons.flash.min.js" type="text/javascript">
        </script>
        <script src="assets/lib/datatables/jszip/jszip.min.js" type="text/javascript"></script>
        <script src="assets/lib/datatables/pdfmake/pdfmake.min.js" type="text/javascript"></script>
        <script src="assets/lib/datatables/pdfmake/vfs_fonts.js" type="text/javascript"></script>
        <script src="assets/lib/datatables/datatables.net-buttons/js/buttons.colVis.min.js" type="text/javascript">
        </script>
        <script src="assets/lib/datatables/datatables.net-buttons/js/buttons.print.min.js" type="text/javascript">
        </script>
        <script src="assets/lib/datatables/datatables.net-buttons/js/buttons.html5.min.js" type="text/javascript">
        </script>
