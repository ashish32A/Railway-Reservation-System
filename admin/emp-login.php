                            ...
                            <form method="POST">
                                <div class="login-form ">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" name="admin_email" type="text" placeholder="Email"
                                            autocomplete="off">
                                    </div>

                                    <div class="form-group">
                                        <input class="form-control" name="admin_pwd" type="password"
                                    ...
                                    <div class="form-group row login-submit">
                                        <div class="col-12"><input type="submit" name="emp_login"
                                                class="btn btn-danger btn-xl btn-block" value="Log In"></div>
                                    </div>
