          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="card card-table">
                <div class="card-header">All Status
                    ...
                    var options = {
                      ...
                      data: [{
                          ...
                          ?>
                            ...
                            { label: "Total passenger", y: <?php echo $passenger;?> },
                            { label: "Total train", y: <?php echo $train;?> },
