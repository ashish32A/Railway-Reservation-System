                            ...
                            <form method="POST">
                                <div class="login-form ">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" name="pass_email" type="text" placeholder="Email"
                                            autocomplete="off">
                                    </div>
                                    ...
                                    <div class="form-group row login-tools">
                                        ...
                                        <div class="col-6 login-forgot-password"><a href="pass-pwd-forgot.php">Forgot
                                                Password?</a></div>
                                    </div>

                                    <div class="form-group row login-submit">
                                        <div class="col-6"><a class="btn btn-danger btn-xl" href="pass-signup.php">Sign
                                                up</a></div>
                                        <div class="col-6"><input type="submit" name="pass_login"
                                                class="btn btn-success btn-xl" value="Log In"></div>
                                    </div>
